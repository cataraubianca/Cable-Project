...
def save_to_files(timestamp, source, destination):
    ...
    def match_withdrawals_destination(timestamp, source, destination):
        ...
        def path(timestamp, source, destination):
            ...
            print("Source prefix: ", dst_prefix)
    ...
    def match_withdrawals_source(timestamp, source, destination):
        ...
        def path(from_time, until_time, src_prefix):
            matches = []
            stream = []
            stream = pybgpstream.BGPStream(
                from_time=from_time,
        ...
        L2 = path(timestamp + 10800, timestamp + 14400, src_prefix)
        L1 = path(timestamp - 14400, timestamp - 10800, src_prefix)
    ...
    write_to_file(real_withdrawal_L1, "real_withdrawal_L1_source_dw.json")
    #print(flap_L1, "flap_L1_source.json")
    write_to_file(flap_L1, "flap_L1_source_dw.json")
    #print(real_withdrawal_L2, "real_withdrawal_L2_source.json")
    write_to_file(real_withdrawal_L2, "real_withdrawal_L2_source_dw.json")
    #print(flap_L2, "flap_L2_source.json")
    write_to_file(flap_L2, "flap_L2_source_dw.json")
