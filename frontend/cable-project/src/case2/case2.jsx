...
import announcements_after from "../data2/announcements_after.json";
import announcements_before from "../data2/announcements_before.json";
import flap_L1_source from "../data2/flap_L1_source.json";
import flap_L2_source from "../data2/flap_L2_source.json";
import real_withdrawal_L1_source from "../data2/real_withdrawal_L1_source.json";
import real_withdrawal_L2_source from "../data2/real_withdrawal_L2_source.json";
import anomalies from "../data2/anomalies.json";
import { Navbar } from "../navbar/navbar";
import delays from "../data2/delays.json";
