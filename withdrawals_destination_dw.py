...
def save_to_files(timestamp, source, destination):
    ...
    write_to_file(real_withdrawal_L1, "real_withdrawal_L1_destination_dw.json")
    #print(flap_L1, "flap_L1_source.json")
    write_to_file(flap_L1, "flap_L1_destination_dw.json")
    #print(real_withdrawal_L2, "real_withdrawal_L2_source.json")
    write_to_file(real_withdrawal_L2, "real_withdrawal_L2_destination_dw.json")
    #print(flap_L2, "flap_L2_source.json")
    write_to_file(flap_L2, "flap_L2_destination_dw.json")
